...
const VendorDashboard = () => {
    ...
    useEffect(() => {
        const vendor = JSON.parse(localStorage.getItem("vendor")); // ✅ Correct key
                ...
                <nav className="col-md-3 col-lg-2 d-md-block bg-dark sidebar py-3">
                    <ul className="nav flex-column">
                        <li className="nav-item">
                            <Link className="nav-link" to="/vendorDashboard/profile">Manage Profile</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/vendorDashboard/services">Manage Services</Link>
                        </li>
                        <li className="nav-item">
                            <Link className="nav-link" to="/vendorDashboard/projects">Manage Projects</Link>
                        </li>
                        <li className="nav-item">
